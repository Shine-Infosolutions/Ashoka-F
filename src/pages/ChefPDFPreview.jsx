  ...
  return (
    <>
      <button
        ...
        className="w-full inline-flex items-center justify-center gap-1 bg-orange-600 text-white rounded hover:bg-orange-700 transition-colors font-medium px-2 py-1.5 text-xs"
      >
